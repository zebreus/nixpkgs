...
{
  pname = "bambu-wrapped";
  version = bambu-unwrapped.version;
  ...
  checkPhase = ''
    ...
    EOT
    $out/bin/bambu min_max.cpp --top-fname=min_max --generate-tb=testbench.xml --simulate --simulator=VERILATOR -v2 --compiler=I386_CLANG16 -O5

    runHook postCheck
  '';

  meta = bambu-unwrapped.meta;
}
